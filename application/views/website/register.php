            ...
            <form action="<?php echo base_url('register-customer')?>" id="loginForm" method="post"  class="php-email-form">
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" name="name" class="form-control" id="name" pattern="[a-zA-Z]+" required>
                </div>
                  <div class="form-group col-md-6 ">
              ...
              <div class="form-group col-md-6 mt-3">
                ...
                <div class="form-group col-md-6 mt-3">
                  <label for="name">Survey  Number<span class="tx-danger">*</span></label>
              ...
              <div class="form-group col-md-6 mt-3">
                <label for="name">Extend Of Land<span class="tx-danger">*</span></label>
