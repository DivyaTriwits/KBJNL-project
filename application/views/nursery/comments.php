        ...
        <main>
            <div class="container-fluid site-width">
                ...
                <div class="row row-eq-height">
                  ...
                  <a href="#"  class="py-2 px-2  rounded ml-auto text-white" data-toggle="modal" data-target="#newtodo" style="background-color: #66CD00">
                                ...
                                <div class="modal fade" id="newtodo">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <form class="" action="<?php echo base_url('Nursery_controller/addNewNurseryComments')?>" method="post">
                                       ...
                                       <?php foreach($comment as $c){?>
                                        <li class="todo-item">
                                            ...
                                            <div class="todo-content">                                                        
                                                ...
                                                <h6><?php echo $c->added_by?></h6>  
                                                <p class="text-muted mb-0 todo-date"><?php echo $c->date?></p>
