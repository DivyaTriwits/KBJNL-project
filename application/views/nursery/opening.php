                                ...
                                <div class="table-responsive">
                                    <table id="example" class="display table dataTable table-striped table-bordered" >
                                        ...
                                        <tbody>
                                               ...
                                               <?php  $i=1; $total=0; $inv=0; $close=0;
                                               foreach($opning as $s){
                                             $stocks=$this->Nursery_model->getOpeningStock($s->id);
                                             // print_r($stockData);exit;
                                             $total+=$stocks->opening_stock;
                                             $inv+=$stocks->inward_quantity;
                                             $close+=$stocks->closing_stock;
                                                ?>
                                             <tr>
                                     ...
                                     <td><?php echo $stocks->sapling?>
                                       ...
                                       <footer>
                                         <tr>
                                           ...
                                           <td align="right"> <?php echo number_format($inv);?></td>
