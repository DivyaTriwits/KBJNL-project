...
<main>
    ...
    <div class="container-fluid site-width">
        ...
        <h3 align="center"><b>Select Nursery</b></h3>
        <div class="row" >

            <?php foreach ($nursery as $eachNursery) {?>
                <div class="col-12 col-lg-6  col-xl-4 mt-3">
                    <a href="<?php echo base_url('varieties-list/'.$eachNursery->nursery_id)?>">
                        <div class="card text-black bg-default shadow-sm" style="height: 100px">
                            <div class="card-body" style="padding-top: 30px">
                                <h3 align="center"><?php echo $eachNursery->nursery_name?></h3>
                            </div>
                        </div>
                    </a>
                </div>
