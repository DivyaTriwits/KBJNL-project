                ...
                <div class="row ">
                    <div class="col-12  align-self-center">
                        <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                            <div class="w-sm-100 mr-auto"><h4 class="mb-0">Cash Income</h4></div>
                            ...
                            <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                                ...
                                <li class="breadcrumb-item active"><a href="#">Cash Income</a></li>
                ...
                <div class="row">
                    <div class="col-12 mt-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                 <form method="GET" action="<?php echo base_url('cash-monthly-report')?>" id="loginForm">
                                <div class="row">
                                       <div class="col-md-3">
                                         ...
                                         <tbody>
                                            ...
                                            <?php $i=1; $total=0;
                                             foreach($filterData as $s){
                                              $total+=$s->pay_amount;
                                               $time=strtotime($s->payment_date);
                                              ?>
                                            <tr>
                                                <td align="right"><?php echo $i;?></td>
                                    
                                                <td><?php echo $s->payment_mode?></td>
                                                <td><?php echo $s->payment_date?></td>
                                                <td><?php echo date("F",$time);?></td>
                                                <td><?php echo $s->pay_amount?></td>
