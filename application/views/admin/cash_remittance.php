                                    ...
                                    <table id="example" class="display table dataTable table-striped table-bordered" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $c->utr?></td>
                                                 <td><?php echo $c->amount?></td>
                                                
                                                    <td><?php echo $c->date?></td>
                                                    <?php if($c->proof != null){?>
                                                    <td> <a href="<?php echo base_url(); ?>uploads/proof/<?php echo $c->proof; ?>" download><img style="height: 100px; width: 70%" src="<?php echo base_url(); ?>uploads/proof/<?php echo $c->proof; ?>" alt="" ></a></td>
                                                <?php } else {?>
                                                    <td></td>
                                                <?php }?>
 ...
 <!-- Modal -->
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <form  id="addVariety" method="post" enctype="multipart/form-data" action="<?php echo base_url('insert-cash-remittance')?>">
                                               ...
                                               <div class="form-row">
                                                   <div class="col-md-4 mb-3">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <input type="text" step="any" class="form-control" id="" name="utr" placeholder="" value="" >
                                                        
                                                    </div>
                                                    <div class="col-md-4 mb-3">
                                                        <label for="">Proof</label>
                                                        <input type="file" step="any" class="form-control" id="" name="proof" placeholder="" value="" >
 ...
 <!--Edit Modal -->
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <form id="editForm" method="post" action="<?php echo base_url('update-cash-remittance')?>">
                                            ...
                                            <div class="modal-body">
                                                   ...
                                                   <div class="col-md-4 mb-3">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <label for="">UTR No</label>
                                                        <input type="text" step="any" class="form-control" id="eutr" name="eutr" placeholder="" value="" >
                                                        
                                                    </div>
                                                    <div class="col-md-4 mb-3">
                                                        <label for="">Proof</label>
                                                        <input type="file" step="any" class="form-control" id="eproof" name="eproof" placeholder="" value="" >
                                ...
                                <div class="modal fade" id="deletevareity" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form class="needs-validation" method="post" action="<?php echo base_url('delete-remittance')?>">
                                            <div class="modal-body">
                                               <div class="form-row">
 ...
 <script>
    function setDataFunction(id,mode,amount,date,utr){
     $('#id').val(id);
     $('#emode').val(mode);
     $('#eamount').val(amount);
     $('#edate').val(date);
