                ...
                <div class="row ">
                    <div class="col-12  align-self-center">
                        <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                            <div class="w-sm-100 mr-auto"><h4 class="mb-0">Seadling Reserve</h4></div>

                            <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                               <li class="breadcrumb-item"><a style="cursor: pointer;" href="<?php echo base_url('admin-dashboard')?>" >Home</a></li>
                                <li class="breadcrumb-item">Seadling Reserve</li>
                                <li class="breadcrumb-item active"><a href="#">Add Seadling Reserve</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="row">                                           
                                        <div class="col-12">
                                            <form id="defaultForm" enctype="multipart/form-data" method="post" action="<?php echo base_url('insert-seedling-reserve')?>">
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-2 mb-3">
                                                     ...
                                                     <input type="text" name="name" class="form-control">
                                                       ...
                                                       <div class="col-md-2 mb-3">
                                                        <label for="">Customer Aadhaar<span class="tx-danger">*</span></label>
                                                    ...
                                                    <div class="col-md-2 mb-3">
                                                        <label for="">Customer Mobile No.<span class="tx-danger">*</span></label>
