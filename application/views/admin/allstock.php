                ...
                <div class="row ">
                    <div class="col-12  align-self-center">
                        <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                            <div class="w-sm-100 mr-auto"><h4 class="mb-0">View All Stock</h4></div>
                            ...
                            <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                               ...
                               <li class="breadcrumb-item"><a style="cursor: pointer;" href="<?php echo base_url('stocks')?>" >Stock</a></li>
                                <li class="breadcrumb-item active"><a href="#">View All Stock</a></li>
                                        ...
                                        <tbody>
                                            ...
                                            $total=0;
                                             foreach($saplings as $s){
                                              $stockData=$this->Admin_model->getCountStock($s->saplingid,$s->bag_id);
                                              $total+=$stockData;
                                             // print_r($stockData);exit;
                                                ?>
                                            <tr>
                                                <td align="right"><?php echo $i;?></td>
                                                <td><?php echo $s->nursery_name?>
                                  </td>
                                     <td><?php echo $s->sapling?>
                                  </td>
                                  
                                                <td align="right"><?php echo $s->bagsize?></td>
                                                 <td align="right"><?php echo number_format($stockData)?></td> 
