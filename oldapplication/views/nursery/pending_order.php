                ...
                <div class="row ">
                    <div class="col-12  align-self-center" style="padding-top: 3px !important; padding-bottom: 3px !important">
                        <div class="sub-header mt-2 py-2 align-self-center d-sm-flex w-100 rounded" style="padding-top: 3px !important; padding-bottom: 3px !important">
                            <div class="w-sm-100 mr-auto"><h4 class="mb-0">Pending Orders</h4></div>
                    ...
                    <div class="col-12 mt-3">
                                    ...
                                    <table id="example" class="display table dataTable table-striped table-bordered" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $o->start_time;?>-<?php echo $o->end_time;?></td>
                      ...
                      <!--)" type="button" class="btn btn" style="background-color: #66CD00; color: white">Reschedule</button></td>-->
                                               <td><a href="<?php echo base_url('order-details/'.$o->order_id)?>" style="color: green; size: 150px !important"><i class="mdi mdi-cryengine"></i></a></td>
                                                <td><a href="<?php echo base_url('view-nursery-payments/'.$o->order_id)?>"><button type="button" class="btn btn-success btn-sm">Payment</button></a></td>
                                            </tr>
                                            <?php $i++;
                                    }?>
                                           </tbody>
                                ...
                                <div class="modal fade" id="schedule" abindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form class="needs-validation" method="post" action="<?php echo base_url('insert-reschedule-orders')?>">
                                            <div class="modal-body">
                                               <div class="form-row">
