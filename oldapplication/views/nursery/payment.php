                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                             ...
                                             <form id="paymentAdd" enctype="multipart/form-data" method="post" action="<?php echo base_url('Nursery_controller/addPayment')?>">
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                             ...
                                             <form id="addVariety" enctype="multipart/form-data" method="post" action="<?php echo base_url('Nursery_controller/editPayment')?>">
                                            <div class="modal-body">
                                ...
                                <div class="modal fade" id="deletevareity" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form class="needs-validation" method="post" action="<?php echo base_url('Nursery_controller/deletePayment')?>">
                                            <div class="modal-body">
                                               <div class="form-row">
