                ...
                <div class="row ">
                    <div class="col-12  align-self-center">
                        <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                            <div class="w-sm-100 mr-auto"><h4 class="mb-0">Add Loss</h4></div>
                            ...
                            <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                               <li class="breadcrumb-item"><a style="cursor: pointer;" href="<?php echo base_url('admin-dashboard')?>" >Home</a></li>
                                ...
                                <li class="breadcrumb-item active"><a href="#">Add Loss</a></li>
                                  <li class="breadcrumb-item"><a href="<?php echo base_url('view-loss')?>"><button type="button" class="btn btn-success btn-sm" style="background-color: #66CD00; border-color:  #66CD00 " >View Loss</button></a>
                                  </li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="row">                                           
                                        <div class="col-12">
                                            <form id="defaultForm" enctype="multipart/form-data" method="post" action="<?php echo base_url('insert-loss')?>">
                                                ...
                                                <div class="row">
                                                 ...
                                                 <div class="col-md-2">
                                                   <div class="form-group">
                                                     ...
                                                     <br>
                                                     <a  class="btn btn-info btn-sm addButton" data-template="textbox" style="color: white; background-color: #66CD00; border-color: #66CD00"><i class="mdi mdi-plus"></i></a>
                                                   </div>
    ...
    $(document).ready(function() {
      ...
      console.log($row);
        ...
        $('#defaultForm').bootstrapValidator('addField', 'bagsize[]');
         ...
         $('#defaultForm').bootstrapValidator('addField', 'loss[]');
...
'loss[]': {
    validators: {
      notEmpty: {
        message: 'The loss type is required.'
    }
}
},
'name': {
