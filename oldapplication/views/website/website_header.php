...
<head>
  ...
  <!-- Favicons -->
  <link href="<?php echo base_url()?>website_assets/img/newlogo.png" rel="icon">
...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="<?php echo base_url('home')?>"><img src="<?php echo base_url()?>website_assets/img/newlogo.png"><span style="color: #228B22">KBJNL</span></a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <!-- <li><a class="nav-link scrollto" href="<?php echo base_url('home')?>">Shop</a></li> -->
