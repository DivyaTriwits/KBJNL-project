      ...
      <nav id="navbar" class="navbar">
        <ul>
         ...
         <?php if(!$this->session->userdata('cust_aadhaar')){ ?>
          <?php if($this->session->userdata('lang')=='EN') { ?>
          <li><a class="getstarted " href="<?php echo base_url('register')?>">Register</a></li>
           <?php } else {?>
<li><a class="getstarted " href="<?php echo base_url('register')?>">ನೋಂದಣಿ</a></li>
             <?php }?>
              <?php if($this->session->userdata('lang')=='EN') { ?>
           <li><a class="getstarted " href="<?php echo base_url('loginWeb')?>">Login</a></li>
            <?php } else {?>
 <li><a class="getstarted " href="<?php echo base_url('loginWeb')?>">ಲಾಗಿನ್</a></li>
              <?php }?>
