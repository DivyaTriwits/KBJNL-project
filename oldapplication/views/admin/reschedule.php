                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                              ...
                                              <td><button data-toggle="modal" data-target="#editSapling"  onclick="setDataFunction('<?php echo $o->order_id; ?>',
                                               ...
                                               <td><a href="<?php echo base_url('view-payments/'.$o->order_id)?>"><button type="button" class="btn btn-success btn-sm">Payment</button></a></td>
                                                     <td><a href="<?php echo base_url('customer-details/'.$o->order_id)?>"><button type="button" class="btn btn-success btn-sm">Details</button></a>
