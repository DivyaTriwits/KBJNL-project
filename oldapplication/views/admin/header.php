...
<!-- Mirrored from html.designstream.co.in/pick/html/layout-horizontal-semidark.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 May 2021 06:38:17 GMT -->
<head>
        <meta charset="UTF-8">
        <title> Admin</title>
...
.loader{
    ...
    <body id="main-container" class="default semi-dark horizontal-menu">
            ...
            <div class="site-width">
                <nav class="navbar navbar-expand-lg  p-0">
                    <div class="navbar-header  h-100 h4 mb-0 align-self-center logo-bar text-left" >
                        <a href="<?php echo base_url('admin-dashboard')?>" class="horizontal-logo text-left">
                        ...
                        <ul class="ml-auto p-0 m-0 list-unstyled d-flex top-icon h-100">
                            ...
                            <li class="dropdown user-profile align-self-center d-inline-block">
                                ...
                                <div class="dropdown-menu border dropdown-menu-right p-0">
                                    ...
                                    <a href="<?php echo base_url('admin-logout');?>" class="dropdown-item px-2 text-danger align-self-center d-flex">
        ...
        <!-- START: Main Menu-->
        <div class="sidebar" style="background-color: #66CD00">
            <div class="site-width">

                <!-- START: Menu-->
                <ul id="side-menu" class="sidebar-menu">
                    <li ><a href="<?php echo base_url('admin-dashboard')?>"><i class="icon-home mr-1"></i> Dashboard</a>
                        
                    </li>
                     <!-- <li class="dropdown active"><a href="#"><i class="icon-organization mr-1"></i> Layout</a>
                        
                    </li> -->
                    <li><a href="<?php echo base_url('varieties')?>"><i class="icon-layers mr-1"></i> Variety</a>
                        
                    </li>
                      <li><a href="<?php echo base_url('bag-sizes')?>"><i class="mdi mdi-weight-gram mr-1"></i> Bag Size</a>
                        
                    </li>
                    <li class="dropdown"><a href="#"><i class="mdi mdi-flower-outline mr-1"></i> Saplings</a>
                        <ul>
                            <li><a href="<?php echo base_url('add-saplings')?>"><i class="mdi mdi-flower"></i> Add Saplings</a></li>
                           <li><a href="<?php echo base_url('view-saplings')?>"><i class="mdi mdi-flower"></i> View Sapling</a></li>
                        </ul> 
                    </li>
                    <li class="dropdown"><a href="<?php echo base_url('nursery')?>"><i class="mdi mdi-google-classroom mr-1"></i>Nursery</a>
                        <ul>
                            <li><a href="<?php echo base_url('nursery')?>"><i class="mdi mdi-account-network"></i> Add Nursery</a></li>
                           <li><a href="<?php echo base_url('view-nursery')?>"><i class="mdi mdi-account-network"></i> View Nursery</a></li>
                        </ul>
                    </li>
                     <li class="dropdown"><a href="<?php echo base_url('nursery')?>"><i class="mdi mdi-database-import mr-1"></i>Stock</a>
                        <ul>
                            <li><a href="<?php echo base_url('stock-add')?>"><i class="mdi mdi-database"></i> Add Stock</a></li>
                           <li><a href="<?php echo base_url('view-stock')?>"><i class="mdi mdi-database"></i> View Stock</a></li>
                           <li><a href="<?php echo base_url('overall-stock')?>"><i class="mdi mdi-database"></i> View Over All Stock</a></li>
                            <li><a href="<?php echo base_url('reservation-stock')?>"><i class="mdi mdi-database"></i>Stock Reservation</a></li>
                        </ul>
                    </li>
                   
                    <li class="dropdown"><a href="<?php echo base_url('view-orders')?>"><i class="mdi mdi-cart mr-1"></i> Order</a>   
                          <ul>
                            <li><a href="<?php echo base_url('all-orders')?>"><i class="mdi mdi-cart-outline"></i> Orders</a></li>
                           <li><a href="<?php echo base_url('all-pending-oreders')?>"><i class="mdi mdi-cart-outline"></i> Confirm Orders</a></li>
                           <li><a href="<?php echo base_url('all-delivered-oreders')?>"><i class="mdi mdi-cart-outline"></i> Delivered Orders</a></li>
                           <li><a href="<?php echo base_url('reschedule-orders')?>"><i class="mdi mdi-cart-outline"></i> Rescheduled Orders</a></li>
                        </ul>
                        </li>
                    <li ><a href="<?php echo base_url('all-payments')?>"><i class="mdi mdi-sack mr-1"></i> Payments</a>
                                            </li>
                     <li><a href="<?php echo base_url('nursery-individual-sapling')?>"><i class="mdi mdi-flower-tulip-outline mr-1"></i>Individual Sapling</a>
                        
                    </li>
                    <li class="dropdown"><a href="<?php echo base_url('nursery')?>"><i class="mdi mdi-database-import mr-1"></i>Account</a>
                        <ul>
                            <li><a href="<?php echo base_url('opening-stock')?>"><i class="mdi mdi-database"></i> Opening Stock</a></li>
                           <li><a href="<?php echo base_url('current-stock')?>"><i class="mdi mdi-database"></i> Current Stock</a></li>
                           <li><a href="<?php echo base_url('sold-sapling')?>"><i class="mdi mdi-database"></i> Sold Sapling</a></li>
                           <li><a href="<?php echo base_url('revenue-generated')?>"><i class="mdi mdi-database"></i> Revenue Generated</a></li>
                        </ul>
                    </li>
                                ...
                                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form  id="changePassword" method="post" action="<?php echo base_url('change-password')?>">
