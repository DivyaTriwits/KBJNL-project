        ...
        <div class="row">
                    <div class="col-12  align-self-center">
                        <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                            <div class="w-sm-100 mr-auto"><h4 class="mb-0">Yield Benifit Uploads</h4> </div>

                            <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                                <li class="breadcrumb-item"><a href="<?php echo base_url('admin-dashboard')?>">Home</a></li>
                                <li class="breadcrumb-item"><a href="<?php echo base_url('uploads-comments')?>">Uploads & Comments</a></li>
                                <li class="breadcrumb-item active">Yield Benifit Uploads</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 mt-3">
              ...
              <div class="row">
                 <div class="col-md-8">
                        ...
                        <h4 class="card-title">Yield Benifit Uploads</h4> 
...
<div class="modal fade" id="editvareity" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form id="editForm" method="post" action="<?php echo base_url('Admin_controller/addBenefitComment')?>">
