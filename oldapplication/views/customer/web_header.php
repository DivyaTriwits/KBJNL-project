  ...
  <section id="topbar" class="d-flex align-items-center" style="background-color: #5cb874">
    <div class="container d-flex justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
        ...
        <i class="bi bi-phone-fill phone-icon" style="color: #ffff"></i><a style="color: #ffff">9886351288</a>
      </div>
      ...
      <nav id="navbar" class="navbar">
        <ul>
         ...
         <?php if(!$this->session->userdata('cust_aadhaar')){ ?>
          <?php if($this->session->userdata('lang')=='EN') { ?>
          <li><a class="getstarted " href="<?php echo base_url('customer-registration')?>">Register</a></li>
           <?php } else {?>
<li><a class="getstarted " href="<?php echo base_url('customer-registration')?>">ನೋಂದಣಿ</a></li>
             <?php }?>
              <?php if($this->session->userdata('lang')=='EN') { ?>
