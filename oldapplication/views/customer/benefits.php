                                ...
                                <tbody>
                                    ...
                                    <?php $i=1;
                                     foreach ($uploads as $eachupload) {?>
                                        <tr>
                                            <td><?php echo $i;?></td>
                                            <td><?php echo $eachupload->subject?></td>
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="myLargeModalLabel10">Yield Benefits </h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                             <form id="formUpload" enctype="multipart/form-data" method="post" action="<?php echo base_url('insert-benefit')?>">
                                            <div class="modal-body">
                                               
                                                <div class="form-row">
                                                  <div class="col-md-6 mb-3">
                                                        <label for="">Subject</label>
                                                      <input type="text" class="form-control" id="location"  name="subject" value="" required> 
