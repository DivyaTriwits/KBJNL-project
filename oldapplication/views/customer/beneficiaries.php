                ...
                <div class="row ">
                    <div class="col-12  align-self-center">
                        <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                            <div class="w-sm-100 mr-auto"><h4 class="mb-0">View Beneficiaries</h4></div>
                            ...
                            <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                                ...
                                <li class="breadcrumb-item active"><a href="#">Beneficiaries</a></li>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="display table dataTable table-striped table-bordered" >
                                        ...
                                        <tbody>
                                            <?php $i=1;
                                             foreach($beneficiaries as $f){?>
                                            <tr>
                                                <td align="right"><?php echo $i;?></td>
                                     <td><?php echo $f->ordered_date?>
                                  </td>
                                                <td><?php echo $f->nursery_name?></td>
                                               
                                               
                                                <td><a align="center" href="<?php echo base_url('beneficiaries-saplings/'.$f->order_id)?>"><i class="mdi mdi-eye-check-outline"></i></a></td>
