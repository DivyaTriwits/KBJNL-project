...
$route['customer-registration'] = $route['default_controller'].'/customerRegistration';
...
$route['delete-cart-product/(:any)'] =  $route['default_controller'].'/deleteCartDetails/$1';
...
$route['privacyPolicy'] = $route['default_controller'].'/privacy';
