...
class Customer_model extends CI_Model
{
	...
	public function registerCustomer(){
		...
		if($this->input->post('name')){
			...
			//$this->session->set_userdata('nursery_id',$this->input->post('nursery'));
			$this->session->set_userdata('cust_aadhaar',$this->input->post('adhaar'));
			$this->session->set_flashdata('success', 'Welcome new user...');
...
// 	}
	...
	public function confirmCustomerOrder(){
		if($this->session->userdata('cust_aadhaar')){
		    //print_r($this->input->post('aadhaarcrad'));exit;
	...
	public function getMyOrders(){
		return $this->db->order_by('orders.id','DESC')->where('customer_aadhaar',$this->session->userdata('cust_aadhaar'))->join('nursery','nursery.nursery_id = orders.nursery_id')->get('orders')->result();
	}
